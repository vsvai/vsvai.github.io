...
<span>
  ...
  <section>
    <div class="max-w-[75rem] mx-auto">
      ...
      <div
        class="max-w-[85rem] px-4 py-6 sm:px-6 lg:px-8 lg:py-10 mx-auto grid grid-cols-2"
      >
        <!-- clients -->
        <div>
          <h1 class="text-3xl md:text-5xl text-center font-semibold mb-4">
            Clients
          </h1>
          <div
          ...
          >
            <img
              class="md:h-32 h-14 object-contain"
        ...
        <div class="relative">
          ...
          >
            ...
            />
            <h4
              class="absolute font-semibold text-lg md:text-2xl md:top-[90%] sm:top-[105%] top-[100%] left-[50%] -translate-x-[50%] -translate-y-[50%]"
            >
              DIPP144606
            </h4>
          </div>
      ...
      <!-- supported by -->
      <div
        class="hidden md:block relative max-w-[85rem] px-4 py-6 sm:px-6 lg:px-8 lg:py-14 mx-auto"
      >
