(function(){const st=document.createElement("link").relList;if(st&&st.supports&&st.supports("modulepreload"))return;for(const W of document.querySelectorAll('link[rel="modulepreload"]'))gt(W);new MutationObserver(W=>{for(const Y of W)if(Y.type==="childList")for(const b of Y.addedNodes)b.tagName==="LINK"&&b.rel==="modulepreload"&&gt(b)}).observe(document,{childList:!0,subtree:!0});function Lt(W){const Y={};return W.integrity&&(Y.integrity=W.integrity),W.referrerPolicy&&(Y.referrerPolicy=W.referrerPolicy),W.crossOrigin==="use-credentials"?Y.credentials="include":W.crossOrigin==="anonymous"?Y.credentials="omit":Y.credentials="same-origin",Y}function gt(W){if(W.ep)return;W.ep=!0;const Y=Lt(W);fetch(W.href,Y)}})();const mn=`<header
...
`,an=document.querySelector("#navbar");an&&(an.innerHTML=mn);const ln=document.querySelector("#footbar");ln&&(ln.innerHTML=vn);const yn=document.getElementById("navButton"),en=document.getElementById("secondNavButton"),bn=document.getElementById("closeBtn"),hn=document.querySelector(".nav-menu"),xn=document.querySelectorAll(".nav-menu a");function fn(){hn.classList.remove("hidden"),document.body.style.overflow="hidden"}function gn(){hn.classList.add("hidden"),document.body.style.overflow=""}yn.addEventListener("click",fn);en==null||en.addEventListener("click",fn);bn.addEventListener("click",gn);xn.forEach(nt=>nt.addEventListener("click",gn));var cn={},wn={get exports(){return cn},set exports(nt){cn=nt}};(function(nt,st){(function(Lt,gt){nt.exports=gt()})(self,()=>(()=>{var Lt={492:(Y,b,y)=>{y.r(b),y.d(b,{afterMain:()=>B,afterRead:()=>I,afterWrite:()=>at,applyStyles:()=>$t,arrow:()=>Ae,auto:()=>h,basePlacements:()=>c,beforeMain:()=>m,beforeRead:()=>l,beforeWrite:()=>G,bottom:()=>w,clippingParents:()=>t,computeStyles:()=>ve,createPopper:()=>Qe,createPopperBase:()=>Le,createPopperLite:()=>Xe,detectOverflow:()=>oe,end:()=>o,eventListeners:()=>de,flip:()=>ie,hide:()=>Be,left:()=>C,main:()=>A,modifierPhases:()=>xt,offset:()=>Me,placements:()=>r,popper:()=>n,popperGenerator:()=>fe,popperOffsets:()=>Ce,preventOverflow:()=>_e,read:()=>u,reference:()=>i,right:()=>v,start:()=>a,top:()=>g,variationPlacements:()=>s,viewport:()=>e,write:()=>q});var g="top",w="bottom",v="right",C="left",h="auto",c=[g,w,v,C],a="start",o="end",t="clippingParents",e="viewport",n="popper",i="reference",s=c.reduce(function(x,d){return x.concat([d+"-"+a,d+"-"+o])},[]),r=[].concat(c,[h]).reduce(function(x,d){return x.concat([d,d+"-"+a,d+"-"+o])},[]),l="beforeRead",u="read",I="afterRead",m="beforeMain",A="main",B="afterMain",G="beforeWrite",q="write",at="afterWrite",xt=[l,u,I,m,A,B,G,q,at];function mt(x){return x?(x.nodeName||"").toLowerCase():null}function it(x){if(x==null)return window;if(x.toString()!=="[object Window]"){var d=x.ownerDocument;return d&&d.defaultView||window}return x}function lt(x){return x instanceof it(x).Element||x instanceof Element}function ct(x){return x instanceof it(x).HTMLElement||x instanceof HTMLElement}function vt(x){return typeof ShadowRoot<"u"&&(x instanceof it(x).ShadowRoot||x instanceof ShadowRoot)}const $t={name:"applyStyles",enabled:!0,phase:"write",fn:function(x){var d=x.state;Object.keys(d.elements).forEach(function(p){var f=d.styles[p]||{},k=d.attributes[p]||{},_=d.elements[p];ct(_)&&mt(_)&&(Object.assign(_.style,f),Object.keys(k).forEach(function(L){var S=k[L];S===!1?_.removeAttribute(L):_.setAttribute(L,S===!0?"":S)}))})},effect:function(x){var d=x.state,p={popper:{position:d.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(d.elements.popper.style,p.popper),d.styles=p,d.elements.arrow&&Object.assign(d.elements.arrow.style,p.arrow),function(){Object.keys(d.elements).forEach(function(f){var k=d.elements[f],_=d.attributes[f]||{},L=Object.keys(d.styles.hasOwnProperty(f)?d.styles[f]:p[f]).reduce(function(S,E){return S[E]="",S},{});ct(k)&&mt(k)&&(Object.assign(k.style,L),Object.keys(_).forEach(function(S){k.removeAttribute(S)}))})}},requires:["computeStyles"]};function wt(x){return x.split("-")[0]}var ht=Math.max,St=Math.min,jt=Math.round;function Dt(){var x=navigator.userAgentData;return x!=null&&x.brands&&Array.isArray(x.brands)?x.brands.map(function(d){return d.brand+"/"+d.version}).join(" "):navigator.userAgent}function Gt(){return!/^((?!chrome|android).)*safari/i.test(Dt())}function Ht(x,d,p){d===void 0&&(d=!1),p===void 0&&(p=!1);var f=x.getBoundingClientRect(),k=1,_=1;d&&ct(x)&&(k=x.offsetWidth>0&&jt(f.width)/x.offsetWidth||1,_=x.offsetHeight>0&&jt(f.height)/x.offsetHeight||1);var L=(lt(x)?it(x):window).visualViewport,S=!Gt()&&p,E=(f.left+(S&&L?L.offsetLeft:0))/k,T=(f.top+(S&&L?L.offsetTop:0))/_,j=f.width/k,O=f.height/_;return{width:j,height:O,top:T,right:E+j,bottom:T+O,left:E,x:E,y:T}}function qt(x){var d=Ht(x),p=x.offsetWidth,f=x.offsetHeight;return Math.abs(d.width-p)<=1&&(p=d.width),Math.abs(d.height-f)<=1&&(f=d.height),{x:x.offsetLeft,y:x.offsetTop,width:p,height:f}}function Zt(x,d){var p=d.getRootNode&&d.getRootNode();if(x.contains(d))return!0;if(p&&vt(p)){var f=d;do{if(f&&x.isSameNode(f))return!0;f=f.parentNode||f.host}while(f)}return!1}function It(x){return it(x).getComputedStyle(x)}function Pt(x){return["table","td","th"].indexOf(mt(x))>=0}function J(x){return((lt(x)?x.ownerDocument:x.document)||window.document).documentElement}function Tt(x){return mt(x)==="html"?x:x.assignedSlot||x.parentNode||(vt(x)?x.host:null)||J(x)}function Qt(x){return ct(x)&&It(x).position!=="fixed"?x.offsetParent:null}function tt(x){for(var d=it(x),p=Qt(x);p&&Pt(p)&&It(p).position==="static";)p=Qt(p);return p&&(mt(p)==="html"||mt(p)==="body"&&It(p).position==="static")?d:p||function(f){var k=/firefox/i.test(Dt());if(/Trident/i.test(Dt())&&ct(f)&&It(f).position==="fixed")return null;var _=Tt(f);for(vt(_)&&(_=_.host);ct(_)&&["html","body"].indexOf(mt(_))<0;){var L=It(_);if(L.transform!=="none"||L.perspective!=="none"||L.contain==="paint"||["transform","perspective"].indexOf(L.willChange)!==-1||k&&L.willChange==="filter"||k&&L.filter&&L.filter!=="none")return _;_=_.parentNode}return null}(x)||d}function Xt(x){return["top","bottom"].indexOf(x)>=0?"x":"y"}function te(x,d,p){return ht(x,St(d,p))}function ae(x){return Object.assign({},{top:0,right:0,bottom:0,left:0},x)}function Te(x,d){return d.reduce(function(p,f){return p[f]=x,p},{})}const Ae={name:"arrow",enabled:!0,phase:"main",fn:function(x){var d,p=x.state,f=x.name,k=x.options,_=p.elements.arrow,L=p.modifiersData.popperOffsets,S=wt(p.placement),E=Xt(S),T=[C,v].indexOf(S)>=0?"height":"width";if(_&&L){var j=function(F,U){return ae(typeof(F=typeof F=="function"?F(Object.assign({},U.rects,{placement:U.placement})):F)!="number"?F:Te(F,c))}(k.padding,p),O=qt(_),P=E==="y"?g:C,z=E==="y"?w:v,$=p.rects.reference[T]+p.rects.reference[E]-L[E]-p.rects.popper[T],Z=L[E]-p.rects.reference[E],H=tt(_),R=H?E==="y"?H.clientHeight||0:H.clientWidth||0:0,Q=$/2-Z/2,K=j[P],N=R-O[T]-j[z],M=R/2-O[T]/2+Q,D=te(K,M,N),V=E;p.modifiersData[f]=((d={})[V]=D,d.centerOffset=D-M,d)}},effect:function(x){var d=x.state,p=x.options.element,f=p===void 0?"[data-popper-arrow]":p;f!=null&&(typeof f!="string"||(f=d.elements.popper.querySelector(f)))&&Zt(d.elements.popper,f)&&(d.elements.arrow=f)},requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function ee(x){return x.split("-")[1]}var le={top:"auto",right:"auto",bottom:"auto",left:"auto"};function Re(x){var d,p=x.popper,f=x.popperRect,k=x.placement,_=x.variation,L=x.offsets,S=x.position,E=x.gpuAcceleration,T=x.adaptive,j=x.roundOffsets,O=x.isFixed,P=L.x,z=P===void 0?0:P,$=L.y,Z=$===void 0?0:$,H=typeof j=="function"?j({x:z,y:Z}):{x:z,y:Z};z=H.x,Z=H.y;var R=L.hasOwnProperty("x"),Q=L.hasOwnProperty("y"),K=C,N=g,M=window;if(T){var D=tt(p),V="clientHeight",F="clientWidth";D===it(p)&&It(D=J(p)).position!=="static"&&S==="absolute"&&(V="scrollHeight",F="scrollWidth"),(k===g||(k===C||k===v)&&_===o)&&(N=w,Z-=(O&&D===M&&M.visualViewport?M.visualViewport.height:D[V])-f.height,Z*=E?1:-1),(k===C||(k===g||k===w)&&_===o)&&(K=v,z-=(O&&D===M&&M.visualViewport?M.visualViewport.width:D[F])-f.width,z*=E?1:-1)}var U,X=Object.assign({position:S},T&&le),et=j===!0?function(rt,dt){var ft=rt.x,yt=rt.y,ot=dt.devicePixelRatio||1;return{x:jt(ft*ot)/ot||0,y:jt(yt*ot)/ot||0}}({x:z,y:Z},it(p)):{x:z,y:Z};return z=et.x,Z=et.y,E?Object.assign({},X,((U={})[N]=Q?"0":"",U[K]=R?"0":"",U.transform=(M.devicePixelRatio||1)<=1?"translate("+z+"px, "+Z+"px)":"translate3d("+z+"px, "+Z+"px, 0)",U)):Object.assign({},X,((d={})[N]=Q?Z+"px":"",d[K]=R?z+"px":"",d.transform="",d))}const ve={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:function(x){var d=x.state,p=x.options,f=p.gpuAcceleration,k=f===void 0||f,_=p.adaptive,L=_===void 0||_,S=p.roundOffsets,E=S===void 0||S,T={placement:wt(d.placement),variation:ee(d.placement),popper:d.elements.popper,popperRect:d.rects.popper,gpuAcceleration:k,isFixed:d.options.strategy==="fixed"};d.modifiersData.popperOffsets!=null&&(d.styles.popper=Object.assign({},d.styles.popper,Re(Object.assign({},T,{offsets:d.modifiersData.popperOffsets,position:d.options.strategy,adaptive:L,roundOffsets:E})))),d.modifiersData.arrow!=null&&(d.styles.arrow=Object.assign({},d.styles.arrow,Re(Object.assign({},T,{offsets:d.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:E})))),d.attributes.popper=Object.assign({},d.attributes.popper,{"data-popper-placement":d.placement})},data:{}};var ce={passive:!0};const de={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:function(x){var d=x.state,p=x.instance,f=x.options,k=f.scroll,_=k===void 0||k,L=f.resize,S=L===void 0||L,E=it(d.elements.popper),T=[].concat(d.scrollParents.reference,d.scrollParents.popper);return _&&T.forEach(function(j){j.addEventListener("scroll",p.update,ce)}),S&&E.addEventListener("resize",p.update,ce),function(){_&&T.forEach(function(j){j.removeEventListener("scroll",p.update,ce)}),S&&E.removeEventListener("resize",p.update,ce)}},data:{}};var Oe={left:"right",right:"left",bottom:"top",top:"bottom"};function ye(x){return x.replace(/left|right|bottom|top/g,function(d){return Oe[d]})}var be={start:"end",end:"start"};function We(x){return x.replace(/start|end/g,function(d){return be[d]})}function xe(x){var d=it(x);return{scrollLeft:d.pageXOffset,scrollTop:d.pageYOffset}}function pe(x){return Ht(J(x)).left+xe(x).scrollLeft}function he(x){var d=It(x),p=d.overflow,f=d.overflowX,k=d.overflowY;return/auto|scroll|overlay|hidden/.test(p+k+f)}function we(x){return["html","body","#document"].indexOf(mt(x))>=0?x.ownerDocument.body:ct(x)&&he(x)?x:we(Tt(x))}function ue(x,d){var p;d===void 0&&(d=[]);var f=we(x),k=f===((p=x.ownerDocument)==null?void 0:p.body),_=it(f),L=k?[_].concat(_.visualViewport||[],he(f)?f:[]):f,S=d.concat(L);return k?S:S.concat(ue(Tt(L)))}function ne(x){return Object.assign({},x,{left:x.x,top:x.y,right:x.x+x.width,bottom:x.y+x.height})}function ke(x,d,p){return d===e?ne(function(f,k){var _=it(f),L=J(f),S=_.visualViewport,E=L.clientWidth,T=L.clientHeight,j=0,O=0;if(S){E=S.width,T=S.height;var P=Gt();(P||!P&&k==="fixed")&&(j=S.offsetLeft,O=S.offsetTop)}return{width:E,height:T,x:j+pe(f),y:O}}(x,p)):lt(d)?function(f,k){var _=Ht(f,!1,k==="fixed");return _.top=_.top+f.clientTop,_.left=_.left+f.clientLeft,_.bottom=_.top+f.clientHeight,_.right=_.left+f.clientWidth,_.width=f.clientWidth,_.height=f.clientHeight,_.x=_.left,_.y=_.top,_}(d,p):ne(function(f){var k,_=J(f),L=xe(f),S=(k=f.ownerDocument)==null?void 0:k.body,E=ht(_.scrollWidth,_.clientWidth,S?S.scrollWidth:0,S?S.clientWidth:0),T=ht(_.scrollHeight,_.clientHeight,S?S.scrollHeight:0,S?S.clientHeight:0),j=-L.scrollLeft+pe(f),O=-L.scrollTop;return It(S||_).direction==="rtl"&&(j+=ht(_.clientWidth,S?S.clientWidth:0)-E),{width:E,height:T,x:j,y:O}}(J(x)))}function Fe(x,d,p,f){var k=d==="clippingParents"?function(E){var T=ue(Tt(E)),j=["absolute","fixed"].indexOf(It(E).position)>=0&&ct(E)?tt(E):E;return lt(j)?T.filter(function(O){return lt(O)&&Zt(O,j)&&mt(O)!=="body"}):[]}(x):[].concat(d),_=[].concat(k,[p]),L=_[0],S=_.reduce(function(E,T){var j=ke(x,T,f);return E.top=ht(j.top,E.top),E.right=St(j.right,E.right),E.bottom=St(j.bottom,E.bottom),E.left=ht(j.left,E.left),E},ke(x,L,f));return S.width=S.right-S.left,S.height=S.bottom-S.top,S.x=S.left,S.y=S.top,S}function Ge(x){var d,p=x.reference,f=x.element,k=x.placement,_=k?wt(k):null,L=k?ee(k):null,S=p.x+p.width/2-f.width/2,E=p.y+p.height/2-f.height/2;switch(_){case g:d={x:S,y:p.y-f.height};break;case w:d={x:S,y:p.y+p.height};break;case v:d={x:p.x+p.width,y:E};break;case C:d={x:p.x-f.width,y:E};break;default:d={x:p.x,y:p.y}}var T=_?Xt(_):null;if(T!=null){var j=T==="y"?"height":"width";switch(L){case a:d[T]=d[T]-(p[j]/2-f[j]/2);break;case o:d[T]=d[T]+(p[j]/2-f[j]/2)}}return d}function oe(x,d){d===void 0&&(d={});var p=d,f=p.placement,k=f===void 0?x.placement:f,_=p.strategy,L=_===void 0?x.strategy:_,S=p.boundary,E=S===void 0?t:S,T=p.rootBoundary,j=T===void 0?e:T,O=p.elementContext,P=O===void 0?n:O,z=p.altBoundary,$=z!==void 0&&z,Z=p.padding,H=Z===void 0?0:Z,R=ae(typeof H!="number"?H:Te(H,c)),Q=P===n?i:n,K=x.rects.popper,N=x.elements[$?Q:P],M=Fe(lt(N)?N:N.contextElement||J(x.elements.popper),E,j,L),D=Ht(x.elements.reference),V=Ge({reference:D,element:K,strategy:"absolute",placement:k}),F=ne(Object.assign({},K,V)),U=P===n?F:D,X={top:M.top-U.top+R.top,bottom:U.bottom-M.bottom+R.bottom,left:M.left-U.left+R.left,right:U.right-M.right+R.right},et=x.modifiersData.offset;if(P===n&&et){var rt=et[k];Object.keys(X).forEach(function(dt){var ft=[v,w].indexOf(dt)>=0?1:-1,yt=[g,w].indexOf(dt)>=0?"y":"x";X[dt]+=rt[yt]*ft})}return X}const ie={name:"flip",enabled:!0,phase:"main",fn:function(x){var d=x.state,p=x.options,f=x.name;if(!d.modifiersData[f]._skip){for(var k=p.mainAxis,_=k===void 0||k,L=p.altAxis,S=L===void 0||L,E=p.fallbackPlacements,T=p.padding,j=p.boundary,O=p.rootBoundary,P=p.altBoundary,z=p.flipVariations,$=z===void 0||z,Z=p.allowedAutoPlacements,H=d.options.placement,R=wt(H),Q=E||(R===H||!$?[ye(H)]:function(kt){if(wt(kt)===h)return[];var pt=ye(kt);return[We(kt),pt,We(pt)]}(H)),K=[H].concat(Q).reduce(function(kt,pt){return kt.concat(wt(pt)===h?function(Ct,Bt){Bt===void 0&&(Bt={});var bt=Bt,Ot=bt.placement,se=bt.boundary,Wt=bt.rootBoundary,Ut=bt.padding,ge=bt.flipVariations,Yt=bt.allowedAutoPlacements,Jt=Yt===void 0?r:Yt,re=ee(Ot),Kt=re?ge?s:s.filter(function(Et){return ee(Et)===re}):c,Ft=Kt.filter(function(Et){return Jt.indexOf(Et)>=0});Ft.length===0&&(Ft=Kt);var Nt=Ft.reduce(function(Et,_t){return Et[_t]=oe(Ct,{placement:_t,boundary:se,rootBoundary:Wt,padding:Ut})[wt(_t)],Et},{});return Object.keys(Nt).sort(function(Et,_t){return Nt[Et]-Nt[_t]})}(d,{placement:pt,boundary:j,rootBoundary:O,padding:T,flipVariations:$,allowedAutoPlacements:Z}):pt)},[]),N=d.rects.reference,M=d.rects.popper,D=new Map,V=!0,F=K[0],U=0;U<K.length;U++){var X=K[U],et=wt(X),rt=ee(X)===a,dt=[g,w].indexOf(et)>=0,ft=dt?"width":"height",yt=oe(d,{placement:X,boundary:j,rootBoundary:O,altBoundary:P,padding:T}),ot=dt?rt?v:C:rt?w:g;N[ft]>M[ft]&&(ot=ye(ot));var ut=ye(ot),At=[];if(_&&At.push(yt[et]<=0),S&&At.push(yt[ot]<=0,yt[ut]<=0),At.every(function(kt){return kt})){F=X,V=!1;break}D.set(X,At)}if(V)for(var Vt=function(kt){var pt=K.find(function(Ct){var Bt=D.get(Ct);if(Bt)return Bt.slice(0,kt).every(function(bt){return bt})});if(pt)return F=pt,"break"},Rt=$?3:1;Rt>0&&Vt(Rt)!=="break";Rt--);d.placement!==F&&(d.modifiersData[f]._skip=!0,d.placement=F,d.reset=!0)}},requiresIfExists:["offset"],data:{_skip:!1}};function je(x,d,p){return p===void 0&&(p={x:0,y:0}),{top:x.top-d.height-p.y,right:x.right-d.width+p.x,bottom:x.bottom-d.height+p.y,left:x.left-d.width-p.x}}function Pe(x){return[g,v,w,C].some(function(d){return x[d]>=0})}const Be={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:function(x){var d=x.state,p=x.name,f=d.rects.reference,k=d.rects.popper,_=d.modifiersData.preventOverflow,L=oe(d,{elementContext:"reference"}),S=oe(d,{altBoundary:!0}),E=je(L,f),T=je(S,k,_),j=Pe(E),O=Pe(T);d.modifiersData[p]={referenceClippingOffsets:E,popperEscapeOffsets:T,isReferenceHidden:j,hasPopperEscaped:O},d.attributes.popper=Object.assign({},d.attributes.popper,{"data-popper-reference-hidden":j,"data-popper-escaped":O})}},Me={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:function(x){var d=x.state,p=x.options,f=x.name,k=p.offset,_=k===void 0?[0,0]:k,L=r.reduce(function(j,O){return j[O]=function(P,z,$){var Z=wt(P),H=[C,g].indexOf(Z)>=0?-1:1,R=typeof $=="function"?$(Object.assign({},z,{placement:P})):$,Q=R[0],K=R[1];return Q=Q||0,K=(K||0)*H,[C,v].indexOf(Z)>=0?{x:K,y:Q}:{x:Q,y:K}}(O,d.rects,_),j},{}),S=L[d.placement],E=S.x,T=S.y;d.modifiersData.popperOffsets!=null&&(d.modifiersData.popperOffsets.x+=E,d.modifiersData.popperOffsets.y+=T),d.modifiersData[f]=L}},Ce={name:"popperOffsets",enabled:!0,phase:"read",fn:function(x){var d=x.state,p=x.name;d.modifiersData[p]=Ge({reference:d.rects.reference,element:d.rects.popper,strategy:"absolute",placement:d.placement})},data:{}},_e={name:"preventOverflow",enabled:!0,phase:"main",fn:function(x){var d=x.state,p=x.options,f=x.name,k=p.mainAxis,_=k===void 0||k,L=p.altAxis,S=L!==void 0&&L,E=p.boundary,T=p.rootBoundary,j=p.altBoundary,O=p.padding,P=p.tether,z=P===void 0||P,$=p.tetherOffset,Z=$===void 0?0:$,H=oe(d,{boundary:E,rootBoundary:T,padding:O,altBoundary:j}),R=wt(d.placement),Q=ee(d.placement),K=!Q,N=Xt(R),M=N==="x"?"y":"x",D=d.modifiersData.popperOffsets,V=d.rects.reference,F=d.rects.popper,U=typeof Z=="function"?Z(Object.assign({},d.rects,{placement:d.placement})):Z,X=typeof U=="number"?{mainAxis:U,altAxis:U}:Object.assign({mainAxis:0,altAxis:0},U),et=d.modifiersData.offset?d.modifiersData.offset[d.placement]:null,rt={x:0,y:0};if(D){if(_){var dt,ft=N==="y"?g:C,yt=N==="y"?w:v,ot=N==="y"?"height":"width",ut=D[N],At=ut+H[ft],Vt=ut-H[yt],Rt=z?-F[ot]/2:0,kt=Q===a?V[ot]:F[ot],pt=Q===a?-F[ot]:-V[ot],Ct=d.elements.arrow,Bt=z&&Ct?qt(Ct):{width:0,height:0},bt=d.modifiersData["arrow#persistent"]?d.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},Ot=bt[ft],se=bt[yt],Wt=te(0,V[ot],Bt[ot]),Ut=K?V[ot]/2-Rt-Wt-Ot-X.mainAxis:kt-Wt-Ot-X.mainAxis,ge=K?-V[ot]/2+Rt+Wt+se+X.mainAxis:pt+Wt+se+X.mainAxis,Yt=d.elements.arrow&&tt(d.elements.arrow),Jt=Yt?N==="y"?Yt.clientTop||0:Yt.clientLeft||0:0,re=(dt=et==null?void 0:et[N])!=null?dt:0,Kt=ut+ge-re,Ft=te(z?St(At,ut+Ut-re-Jt):At,ut,z?ht(Vt,Kt):Vt);D[N]=Ft,rt[N]=Ft-ut}if(S){var Nt,Et=N==="x"?g:C,_t=N==="x"?w:v,Mt=D[M],zt=M==="y"?"height":"width",me=Mt+H[Et],qe=Mt-H[_t],Ee=[g,C].indexOf(R)!==-1,Se=(Nt=et==null?void 0:et[M])!=null?Nt:0,He=Ee?me:Mt-V[zt]-F[zt]-Se+X.altAxis,Ne=Ee?Mt+V[zt]+F[zt]-Se-X.altAxis:qe,Ve=z&&Ee?function(Ye,tn,ze){var Ie=te(Ye,tn,ze);return Ie>ze?ze:Ie}(He,Mt,Ne):te(z?He:me,Mt,z?Ne:qe);D[M]=Ve,rt[M]=Ve-Mt}d.modifiersData[f]=rt}},requiresIfExists:["offset"]};function Ze(x,d,p){p===void 0&&(p=!1);var f,k,_=ct(d),L=ct(d)&&function(O){var P=O.getBoundingClientRect(),z=jt(P.width)/O.offsetWidth||1,$=jt(P.height)/O.offsetHeight||1;return z!==1||$!==1}(d),S=J(d),E=Ht(x,L,p),T={scrollLeft:0,scrollTop:0},j={x:0,y:0};return(_||!_&&!p)&&((mt(d)!=="body"||he(S))&&(T=(f=d)!==it(f)&&ct(f)?{scrollLeft:(k=f).scrollLeft,scrollTop:k.scrollTop}:xe(f)),ct(d)?((j=Ht(d,!0)).x+=d.clientLeft,j.y+=d.clientTop):S&&(j.x=pe(S))),{x:E.left+T.scrollLeft-j.x,y:E.top+T.scrollTop-j.y,width:E.width,height:E.height}}function Ke(x){var d=new Map,p=new Set,f=[];function k(_){p.add(_.name),[].concat(_.requires||[],_.requiresIfExists||[]).forEach(function(L){if(!p.has(L)){var S=d.get(L);S&&k(S)}}),f.push(_)}return x.forEach(function(_){d.set(_.name,_)}),x.forEach(function(_){p.has(_.name)||k(_)}),f}var Ue={placement:"bottom",modifiers:[],strategy:"absolute"};function De(){for(var x=arguments.length,d=new Array(x),p=0;p<x;p++)d[p]=arguments[p];return!d.some(function(f){return!(f&&typeof f.getBoundingClientRect=="function")})}function fe(x){x===void 0&&(x={});var d=x,p=d.defaultModifiers,f=p===void 0?[]:p,k=d.defaultOptions,_=k===void 0?Ue:k;return function(L,S,E){E===void 0&&(E=_);var T,j,O={placement:"bottom",orderedModifiers:[],options:Object.assign({},Ue,_),modifiersData:{},elements:{reference:L,popper:S},attributes:{},styles:{}},P=[],z=!1,$={state:O,setOptions:function(H){var R=typeof H=="function"?H(O.options):H;Z(),O.options=Object.assign({},_,O.options,R),O.scrollParents={reference:lt(L)?ue(L):L.contextElement?ue(L.contextElement):[],popper:ue(S)};var Q,K,N=function(M){var D=Ke(M);return xt.reduce(function(V,F){return V.concat(D.filter(function(U){return U.phase===F}))},[])}((Q=[].concat(f,O.options.modifiers),K=Q.reduce(function(M,D){var V=M[D.name];return M[D.name]=V?Object.assign({},V,D,{options:Object.assign({},V.options,D.options),data:Object.assign({},V.data,D.data)}):D,M},{}),Object.keys(K).map(function(M){return K[M]})));return O.orderedModifiers=N.filter(function(M){return M.enabled}),O.orderedModifiers.forEach(function(M){var D=M.name,V=M.options,F=V===void 0?{}:V,U=M.effect;if(typeof U=="function"){var X=U({state:O,name:D,instance:$,options:F}),et=function(){};P.push(X||et)}}),$.update()},forceUpdate:function(){if(!z){var H=O.elements,R=H.reference,Q=H.popper;if(De(R,Q)){O.rects={reference:Ze(R,tt(Q),O.options.strategy==="fixed"),popper:qt(Q)},O.reset=!1,O.placement=O.options.placement,O.orderedModifiers.forEach(function(U){return O.modifiersData[U.name]=Object.assign({},U.data)});for(var K=0;K<O.orderedModifiers.length;K++)if(O.reset!==!0){var N=O.orderedModifiers[K],M=N.fn,D=N.options,V=D===void 0?{}:D,F=N.name;typeof M=="function"&&(O=M({state:O,options:V,name:F,instance:$})||O)}else O.reset=!1,K=-1}}},update:(T=function(){return new Promise(function(H){$.forceUpdate(),H(O)})},function(){return j||(j=new Promise(function(H){Promise.resolve().then(function(){j=void 0,H(T())})})),j}),destroy:function(){Z(),z=!0}};if(!De(L,S))return $;function Z(){P.forEach(function(H){return H()}),P=[]}return $.setOptions(E).then(function(H){!z&&E.onFirstUpdate&&E.onFirstUpdate(H)}),$}}var Le=fe(),Qe=fe({defaultModifiers:[de,Ce,ve,$t,Me,ie,_e,Ae,Be]}),Xe=fe({defaultModifiers:[de,Ce,ve,$t]})},190:(Y,b)=>{Object.defineProperty(b,"__esModule",{value:!0}),b.BREAKPOINTS=b.COMBO_BOX_ACCESSIBILITY_KEY_SET=b.SELECT_ACCESSIBILITY_KEY_SET=b.TABS_ACCESSIBILITY_KEY_SET=b.OVERLAY_ACCESSIBILITY_KEY_SET=b.DROPDOWN_ACCESSIBILITY_KEY_SET=b.POSITIONS=void 0,b.POSITIONS={auto:"auto","auto-start":"auto-start","auto-end":"auto-end",top:"top","top-left":"top-start","top-right":"top-end",bottom:"bottom","bottom-left":"bottom-start","bottom-right":"bottom-end",right:"right","right-start":"right-start","right-end":"right-end",left:"left","left-start":"left-start","left-end":"left-end"},b.DROPDOWN_ACCESSIBILITY_KEY_SET=["Escape","ArrowUp","ArrowDown","Home","End","Enter"],b.OVERLAY_ACCESSIBILITY_KEY_SET=["Escape","Tab"],b.TABS_ACCESSIBILITY_KEY_SET=["ArrowUp","ArrowLeft","ArrowDown","ArrowRight","Home","End"],b.SELECT_ACCESSIBILITY_KEY_SET=["ArrowUp","ArrowLeft","ArrowDown","ArrowRight","Home","End","Escape","Enter","Tab"],b.COMBO_BOX_ACCESSIBILITY_KEY_SET=["ArrowUp","ArrowLeft","ArrowDown","ArrowRight","Home","End","Escape","Enter"],b.BREAKPOINTS={sm:640,md:768,lg:1024,xl:1280,"2xl":1536}},700:function(Y,b,y){var g=this&&this.__importDefault||function(at){return at&&at.__esModule?at:{default:at}};Object.defineProperty(b,"__esModule",{value:!0}),b.HSStaticMethods=b.HSTooltip=b.HSTogglePassword=b.HSToggleCount=b.HSThemeSwitch=b.HSTabs=b.HSStrongPassword=b.HSStepper=b.HSSelect=b.HSScrollspy=b.HSSearchByJson=b.HSRemoveElement=b.HSPinInput=b.HSOverlay=b.HSInputNumber=b.HSDropdown=b.HSComboBox=b.HSCollapse=b.HSCarousel=b.HSAccordion=b.HSCopyMarkup=void 0;var w=y(413);Object.defineProperty(b,"HSCopyMarkup",{enumerable:!0,get:function(){return g(w).default}});var v=y(460);Object.defineProperty(b,"HSAccordion",{enumerable:!0,get:function(){return g(v).default}});var C=y(629);Object.defineProperty(b,"HSCarousel",{enumerable:!0,get:function(){return g(C).default}});var h=y(652);Object.defineProperty(b,"HSCollapse",{enumerable:!0,get:function(){return g(h).default}});var c=y(23);Object.defineProperty(b,"HSComboBox",{enumerable:!0,get:function(){return g(c).default}});var a=y(610);Object.defineProperty(b,"HSDropdown",{enumerable:!0,get:function(){return g(a).default}});var o=y(371);Object.defineProperty(b,"HSInputNumber",{enumerable:!0,get:function(){return g(o).default}});var t=y(770);Object.defineProperty(b,"HSOverlay",{enumerable:!0,get:function(){return g(t).default}});var e=y(659);Object.defineProperty(b,"HSPinInput",{enumerable:!0,get:function(){return g(e).default}});var n=y(139);Object.defineProperty(b,"HSRemoveElement",{enumerable:!0,get:function(){return g(n).default}});var i=y(961);Object.defineProperty(b,"HSSearchByJson",{enumerable:!0,get:function(){return g(i).default}});var s=y(591);Object.defineProperty(b,"HSScrollspy",{enumerable:!0,get:function(){return g(s).default}});var r=y(233);Object.defineProperty(b,"HSSelect",{enumerable:!0,get:function(){return g(r).default}});var l=y(957);Object.defineProperty(b,"HSStepper",{enumerable:!0,get:function(){return g(l).default}});var u=y(983);Object.defineProperty(b,"HSStrongPassword",{enumerable:!0,get:function(){return g(u).default}});var I=y(949);Object.defineProperty(b,"HSTabs",{enumerable:!0,get:function(){return g(I).default}});var m=y(557);Object.defineProperty(b,"HSThemeSwitch",{enumerable:!0,get:function(){return g(m).default}});var A=y(87);Object.defineProperty(b,"HSToggleCount",{enumerable:!0,get:function(){return g(A).default}});var B=y(366);Object.defineProperty(b,"HSTogglePassword",{enumerable:!0,get:function(){return g(B).default}});var G=y(679);Object.defineProperty(b,"HSTooltip",{enumerable:!0,get:function(){return g(G).default}});var q=y(313);Object.defineProperty(b,"HSStaticMethods",{enumerable:!0,get:function(){return g(q).default}})},460:function(Y,b,y){/*
 * HSAccordion
 * @version: 2.1.0
 * @author: HTMLStream
 * @license: Licensed under MIT (https://preline.co/docs/license.html)
 * Copyright 2023 HTMLStream
 */var g,w=this&&this.__extends||(g=function(a,o){return g=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n])},g(a,o)},function(a,o){if(typeof o!="function"&&o!==null)throw new TypeError("Class extends value "+String(o)+" is not a constructor or null");function t(){this.constructor=a}g(a,o),a.prototype=o===null?Object.create(o):(t.prototype=o.prototype,new t)}),v=this&&this.__assign||function(){return v=Object.assign||function(a){for(var o,t=1,e=arguments.length;t<e;t++)for(var n in o=arguments[t])Object.prototype.hasOwnProperty.call(o,n)&&(a[n]=o[n]);return a},v.apply(this,arguments)},C=this&&this.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(b,"__esModule",{value:!0});var h=y(969),c=function(a){function o(t,e,n){var i=a.call(this,t,e,n)||this;return i.toggle=i.el.querySelector(".hs-accordion-toggle")||null,i.content=i.el.querySelector(".hs-accordion-content")||null,i.group=i.el.closest(".hs-accordion-group")||null,i.isAlwaysOpened=i.group.hasAttribute("data-hs-accordion-always-open")||!1,i.toggle&&i.content&&i.init(),i}return w(o,a),o.prototype.init=function(){var t=this;this.createCollection(window.$hsAccordionCollection,this),this.toggle.addEventListener("click",function(e){e.stopPropagation(),t.el.classList.contains("active")?t.hide():t.show()})},o.prototype.show=function(){var t=this;if(this.group&&!this.isAlwaysOpened&&this.group.querySelector(":scope > .hs-accordion.active")&&this.group.querySelector(":scope > .hs-accordion.active")!==this.el&&window.$hsAccordionCollection.find(function(e){return e.element.el===t.group.querySelector(":scope > .hs-accordion.active")}).element.hide(),this.el.classList.contains("active"))return!1;this.el.classList.add("active"),this.content.style.display="block",this.content.style.height="0",setTimeout(function(){t.content.style.height="".concat(t.content.scrollHeight,"px")}),(0,h.afterTransition)(this.content,function(){t.content.style.display="block",t.content.style.height="",t.fireEvent("open",t.el),(0,h.dispatch)("open.hs.accordion",t.el,t.el)})},o.prototype.hide=function(){var t=this;if(!this.el.classList.contains("active"))return!1;this.el.classList.remove("active"),this.content.style.height="".concat(this.content.scrollHeight,"px"),setTimeout(function(){t.content.style.height="0"}),(0,h.afterTransition)(this.content,function(){t.content.style.display="",t.content.style.height="0",t.fireEvent("close",t.el),(0,h.dispatch)("close.hs.accordion",t.el,t.el)})},o.getInstance=function(t,e){var n=window.$hsAccordionCollection.find(function(i){return i.element.el===(typeof t=="string"?document.querySelector(t):t)});return n?e?n:n.element.el:null},o.show=function(t){var e=window.$hsAccordionCollection.find(function(n){return n.element.el===(typeof t=="string"?document.querySelector(t):t)});e&&e.element.content.style.display!=="block"&&e.element.show()},o.hide=function(t){var e=window.$hsAccordionCollection.find(function(n){return n.element.el===(typeof t=="string"?document.querySelector(t):t)});e&&e.element.content.style.display==="block"&&e.element.hide()},o.autoInit=function(){window.$hsAccordionCollection||(window.$hsAccordionCollection=[]),document.querySelectorAll(".hs-accordion:not(.--prevent-on-load-init)").forEach(function(t){window.$hsAccordionCollection.find(function(e){var n;return((n=e==null?void 0:e.element)===null||n===void 0?void 0:n.el)===t})||new o(t)})},o.treeView=function(){var t=this;if(!document.querySelectorAll(".hs-accordion-treeview-root").length)return!1;this.selectable=[],document.querySelectorAll(".hs-accordion-treeview-root").forEach(function(e){var n=e==null?void 0:e.getAttribute("data-hs-accordion-options"),i=n?JSON.parse(n):{};t.selectable.push({el:e,options:v({},i)})}),this.selectable.length&&this.selectable.forEach(function(e){e.el.querySelectorAll(".hs-accordion-selectable").forEach(function(n){n.addEventListener("click",function(i){i.stopPropagation(),t.toggleSelected(e,n)})})})},o.toggleSelected=function(t,e){e.classList.contains("selected")?e.classList.remove("selected"):(t.el.querySelectorAll(".hs-accordion-selectable").forEach(function(n){return n.classList.remove("selected")}),e.classList.add("selected"))},o.on=function(t,e,n){var i=window.$hsAccordionCollection.find(function(s){return s.element.el===(typeof e=="string"?document.querySelector(e):e)});i&&(i.element.events[t]=n)},o}(C(y(737)).default);window.addEventListener("load",function(){c.autoInit(),document.querySelectorAll(".hs-accordion-treeview-root").length&&c.treeView()}),typeof window<"u"&&(window.HSAccordion=c),b.default=c},737:(Y,b)=>{/*
 * HSBasePlugin
 * @version: 2.1.0
 * @author: HTMLStream
 * @license: Licensed under MIT (https://preline.co/docs/license.html)
 * Copyright 2023 HTMLStream
 */Object.defineProperty(b,"__esModule",{value:!0});var y=function(){function g(w,v,C){this.el=w,this.options=v,this.events=C,this.el=w,this.options=v,this.events={}}return g.prototype.createCollection=function(w,v){var C;w.push({id:((C=v==null?void 0:v.el)===null||C===void 0?void 0:C.id)||w.length+1,element:v})},g.prototype.fireEvent=function(w,v){if(v===void 0&&(v=null),this.events.hasOwnProperty(w))return this.events[w](v)},g.prototype.on=function(w,v){this.events[w]=v},g}();b.default=y},629:function(Y,b,y){/*
 * HSCarousel
 * @version: 2.1.0
 * @author: HTMLStream
 * @license: Licensed under MIT (https://preline.co/docs/license.html)
 * Copyright 2023 HTMLStream
 */var g,w=this&&this.__extends||(g=function(c,a){return g=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(o,t){o.__proto__=t}||function(o,t){for(var e in t)Object.prototype.hasOwnProperty.call(t,e)&&(o[e]=t[e])},g(c,a)},function(c,a){if(typeof a!="function"&&a!==null)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");function o(){this.constructor=c}g(c,a),c.prototype=a===null?Object.create(a):(o.prototype=a.prototype,new o)}),v=this&&this.__assign||function(){return v=Object.assign||function(c){for(var a,o=1,t=arguments.length;o<t;o++)for(var e in a=arguments[o])Object.prototype.hasOwnProperty.call(a,e)&&(c[e]=a[e]);return c},v.apply(this,arguments)},C=this&&this.__importDefault||function(c){return c&&c.__esModule?c:{default:c}};Object.defineProperty(b,"__esModule",{value:!0});var h=function(c){function a(o,t){var e,n,i,s=c.call(this,o,t)||this,r=o.getAttribute("data-hs-carousel"),l=r?JSON.parse(r):{},u=v(v({},l),t);return s.currentIndex=u.currentIndex||0,s.loadingClasses=u.loadingClasses?"".concat(u.loadingClasses).split(","):null,s.loadingClassesRemove=!((e=s.loadingClasses)===null||e===void 0)&&e[0]?s.loadingClasses[0].split(" "):"opacity-0",s.loadingClassesAdd=!((n=s.loadingClasses)===null||n===void 0)&&n[1]?s.loadingClasses[1].split(" "):"",s.afterLoadingClassesAdd=!((i=s.loadingClasses)===null||i===void 0)&&i[2]?s.loadingClasses[2].split(" "):"",s.isAutoPlay=u.isAutoPlay!==void 0&&u.isAutoPlay,s.speed=u.speed||4e3,s.isInfiniteLoop=u.isInfiniteLoop===void 0||u.isInfiniteLoop,s.inner=s.el.querySelector(".hs-carousel-body")||null,s.slides=s.el.querySelectorAll(".hs-carousel-slide")||[],s.prev=s.el.querySelector(".hs-carousel-prev")||null,s.next=s.el.querySelector(".hs-carousel-next")||null,s.dots=s.el.querySelectorAll(".hs-carousel-pagination > *")||null,s.sliderWidth=s.inner.parentElement.clientWidth,s.touchX={start:0,end:0},s.init(),s}return w(a,c),a.prototype.init=function(){var o,t,e=this;this.createCollection(window.$hsCarouselCollection,this),this.inner&&(this.calculateWidth(),this.loadingClassesRemove&&(typeof this.loadingClassesRemove=="string"?this.inner.classList.remove(this.loadingClassesRemove):(o=this.inner.classList).remove.apply(o,this.loadingClassesRemove)),this.loadingClassesAdd&&(typeof this.loadingClassesAdd=="string"?this.inner.classList.add(this.loadingClassesAdd):(t=this.inner.classList).add.apply(t,this.loadingClassesAdd))),this.prev&&this.prev.addEventListener("click",function(){e.goToPrev(),e.isAutoPlay&&(e.resetTimer(),e.setTimer())}),this.next&&this.next.addEventListener("click",function(){e.goToNext(),e.isAutoPlay&&(e.resetTimer(),e.setTimer())}),this.dots&&this.dots.forEach(function(n,i){return n.addEventListener("click",function(){e.goTo(i),e.isAutoPlay&&(e.resetTimer(),e.setTimer())})}),this.slides.length&&(this.addCurrentClass(),this.isInfiniteLoop||this.addDisabledClass(),this.isAutoPlay&&this.autoPlay()),this.inner&&this.afterLoadingClassesAdd&&setTimeout(function(){var n;typeof e.afterLoadingClassesAdd=="string"?e.inner.classList.add(e.afterLoadingClassesAdd):(n=e.inner.classList).add.apply(n,e.afterLoadingClassesAdd)}),this.el.classList.add("init"),this.el.addEventListener("touchstart",function(n){e.touchX.start=n.changedTouches[0].screenX}),this.el.addEventListener("touchend",function(n){e.touchX.end=n.changedTouches[0].screenX,e.detectDirection()}),this.observeResize()},a.prototype.observeResize=function(){var o=this;new ResizeObserver(function(){return o.recalculateWidth()}).observe(document.querySelector("body"))},a.prototype.calculateWidth=function(){var o=this;this.inner.style.width="".concat(this.sliderWidth*this.slides.length,"px"),this.inner.style.transform="translate(-".concat(this.currentIndex*this.sliderWidth,"px, 0px)"),this.slides.forEach(function(t){t.style.width="".concat(o.sliderWidth,"px")})},a.prototype.addCurrentClass=function(){var o=this;this.slides.forEach(function(t,e){e===o.currentIndex?t.classList.add("active"):t.classList.remove("active")}),this.dots&&this.dots.forEach(function(t,e){e===o.currentIndex?t.classList.add("active"):t.classList.remove("active")})},a.prototype.addDisabledClass=function(){if(!this.prev||!this.next)return!1;this.currentIndex===0?(this.next.classList.remove("disabled"),this.prev.classList.add("disabled")):this.currentIndex===this.slides.length-1?(this.prev.classList.remove("disabled"),this.next.classList.add("disabled")):(this.prev.classList.remove("disabled"),this.next.classList.remove("disabled"))},a.prototype.autoPlay=function(){this.setTimer()},a.prototype.setTimer=function(){var o=this;this.timer=setInterval(function(){o.currentIndex===o.slides.length-1?o.goTo(0):o.goToNext()},this.speed)},a.prototype.resetTimer=function(){clearInterval(this.timer)},a.prototype.detectDirection=function(){var o=this.touchX,t=o.start,e=o.end;e<t&&this.goToNext(),e>t&&this.goToPrev()},a.prototype.recalculateWidth=function(){this.sliderWidth=this.inner.parentElement.clientWidth,this.calculateWidth()},a.prototype.goToPrev=function(){this.currentIndex===0&&this.isInfiniteLoop?(this.currentIndex=this.slides.length-1,this.inner.style.transform="translate(-".concat(this.currentIndex*this.sliderWidth,"px, 0px)"),this.addCurrentClass()):this.currentIndex!==0&&(this.currentIndex-=1,this.inner.style.transform="translate(-".concat(this.currentIndex*this.sliderWidth,"px, 0px)"),this.addCurrentClass(),this.addDisabledClass())},a.prototype.goToNext=function(){this.currentIndex===this.slides.length-1&&this.isInfiniteLoop?(this.currentIndex=0,this.inner.style.transform="translate(-".concat(this.currentIndex*this.sliderWidth,"px, 0px)"),this.addCurrentClass()):this.currentIndex<this.slides.length-1&&(this.currentIndex+=1,this.inner.style.transform="translate(-".concat(this.currentIndex*this.sliderWidth,"px, 0px)"),this.addCurrentClass(),this.addDisabledClass())},a.prototype.goTo=function(o){this.currentIndex=o,this.inner.style.transform="translate(-".concat(this.currentIndex*this.sliderWidth,"px, 0px)"),this.addCurrentClass(),this.isInfiniteLoop||this.addDisabledClass()},a.getInstance=function(o,t){var e=window.$hsCarouselCollection.find(function(n){return n.element.el===(typeof o=="string"?document.querySelector(o):o)});return e?t?e:e.element:null},a.autoInit=function(){window.$hsCarouselCollection||(window.$hsCarouselCollection=[]),document.querySelectorAll("[data-hs-carousel]:not(.--prevent-on-load-init)").forEach(function(o){window.$hsCarouselCollection.find(function(t){var e;return((e=t==null?void 0:t.element)===null||e===void 0?void 0:e.el)===o})||new a(o)})},a}(C(y(737)).default);window.addEventListener("load",function(){h.autoInit()}),window.addEventListener("resize",function(){if(!window.$hsCarouselCollection)return!1;window.$hsCarouselCollection.forEach(function(c){c.element.recalculateWidth()})}),typeof window<"u"&&(window.HSCarousel=h),b.default=h},652:function(Y,b,y){/*
 * HSCollapse
 * @version: 2.1.0
 * @author: HTMLStream
 * @license: Licensed under MIT (https://preline.co/docs/license.html)
 * Copyright 2023 HTMLStream
 */var g,w=this&&this.__extends||(g=function(c,a){return g=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(o,t){o.__proto__=t}||function(o,t){for(var e in t)Object.prototype.hasOwnProperty.call(t,e)&&(o[e]=t[e])},g(c,a)},function(c,a){if(typeof a!="function"&&a!==null)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");function o(){this.constructor=c}g(c,a),c.prototype=a===null?Object.create(a):(o.prototype=a.prototype,new o)}),v=this&&this.__importDefault||function(c){return c&&c.__esModule?c:{default:c}};Object.defineProperty(b,"__esModule",{value:!0});var C=y(969),h=function(c){function a(o,t,e){var n=c.call(this,o,t,e)||this;return n.contentId=n.el.dataset.hsCollapse,n.content=document.querySelector(n.contentId),n.animationInProcess=!1,n.content&&n.init(),n}return w(a,c),a.prototype.init=function(){var o=this;this.createCollection(window.$hsCollapseCollection,this),this.el.addEventListener("click",function(){o.content.classList.contains("open")?o.hide():o.show()})},a.prototype.hideAllMegaMenuItems=function(){this.content.querySelectorAll(".hs-mega-menu-content.block").forEach(function(o){o.classList.remove("block"),o.classList.add("hidden")})},a.prototype.show=function(){var o=this;if(this.animationInProcess||this.el.classList.contains("open"))return!1;this.animationInProcess=!0,this.el.classList.add("open"),this.content.classList.add("open"),this.content.classList.remove("hidden"),this.content.style.height="0",setTimeout(function(){o.content.style.height="".concat(o.content.scrollHeight,"px"),o.fireEvent("beforeOpen",o.el),(0,C.dispatch)("beforeOpen.hs.collapse",o.el,o.el)}),(0,C.afterTransition)(this.content,function(){o.content.style.height="",o.fireEvent("open",o.el),(0,C.dispatch)("open.hs.collapse",o.el,o.el),o.animationInProcess=!1})},a.prototype.hide=function(){var o=this;if(this.animationInProcess||!this.el.classList.contains("open"))return!1;this.animationInProcess=!0,this.el.classList.remove("open"),this.content.style.height="".concat(this.content.scrollHeight,"px"),setTimeout(function(){o.content.style.height="0"}),this.content.classList.remove("open"),(0,C.afterTransition)(this.content,function(){o.content.classList.add("hidden"),o.content.style.height="",o.fireEvent("hide",o.el),(0,C.dispatch)("hide.hs.collapse",o.el,o.el),o.animationInProcess=!1}),this.content.querySelectorAll(".hs-mega-menu-content.block").length&&this.hideAllMegaMenuItems()},a.getInstance=function(o,t){t===void 0&&(t=!1);var e=window.$hsCollapseCollection.find(function(n){return n.element.el===(typeof o=="string"?document.querySelector(o):o)});return e?t?e:e.element.el:null},a.autoInit=function(){window.$hsCollapseCollection||(window.$hsCollapseCollection=[]),document.querySelectorAll(".hs-collapse-toggle:not(.--prevent-on-load-init)").forEach(function(o){window.$hsCollapseCollection.find(function(t){var e;return((e=t==null?void 0:t.element)===null||e===void 0?void 0:e.el)===o})||new a(o)})},a.show=function(o){var t=window.$hsCollapseCollection.find(function(e){return e.element.el===(typeof o=="string"?document.querySelector(o):o)});t&&t.element.content.classList.contains("hidden")&&t.element.show()},a.hide=function(o){var t=window.$hsCollapseCollection.find(function(e){return e.element.el===(typeof o=="string"?document.querySelector(o):o)});t&&!t.element.content.classList.contains("hidden")&&t.element.hide()},a.on=function(o,t,e){var n=window.$hsCollapseCollection.find(function(i){return i.element.el===(typeof t=="string"?document.querySelector(t):t)});n&&(n.element.events[o]=e)},a}(v(y(737)).default);window.addEventListener("load",function(){h.autoInit()}),typeof window<"u"&&(window.HSCollapse=h),b.default=h},23:function(Y,b,y){/*
 * HSComboBox
 * @version: 2.1.0
 * @author: HTMLStream
 * @license: Licensed under MIT (https://preline.co/docs/license.html)
 * Copyright 2023 HTMLStream
 */var g,w=this&&this.__extends||(g=function(i,s){return g=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,l){r.__proto__=l}||function(r,l){for(var u in l)Object.prototype.hasOwnProperty.call(l,u)&&(r[u]=l[u])},g(i,s)},function(i,s){if(typeof s!="function"&&s!==null)throw new TypeError("Class extends value "+String(s)+" is not a constructor or null");function r(){this.constructor=i}g(i,s),i.prototype=s===null?Object.create(s):(r.prototype=s.prototype,new r)}),v=this&&this.__assign||function(){return v=Object.assign||function(i){for(var s,r=1,l=arguments.length;r<l;r++)for(var u in s=arguments[r])Object.prototype.hasOwnProperty.call(s,u)&&(i[u]=s[u]);return i},v.apply(this,arguments)},C=this&&this.__awaiter||function(i,s,r,l){return new(r||(r=Promise))(function(u,I){function m(G){try{B(l.next(G))}catch(q){I(q)}}function A(G){try{B(l.throw(G))}catch(q){I(q)}}function B(G){var q;G.done?u(G.value):(q=G.value,q instanceof r?q:new r(function(at){at(q)})).then(m,A)}B((l=l.apply(i,s||[])).next())})},h=this&&this.__generator||function(i,s){var r,l,u,I,m={label:0,sent:function(){if(1&u[0])throw u[1];return u[1]},trys:[],ops:[]};return I={next:A(0),throw:A(1),return:A(2)},typeof Symbol=="function"&&(I[Symbol.iterator]=function(){return this}),I;function A(B){return function(G){return function(q){if(r)throw new TypeError("Generator is already executing.");for(;I&&(I=0,q[0]&&(m=0)),m;)try{if(r=1,l&&(u=2&q[0]?l.return:q[0]?l.throw||((u=l.return)&&u.call(l),0):l.next)&&!(u=u.call(l,q[1])).done)return u;switch(l=0,u&&(q=[2&q[0],u.value]),q[0]){case 0:case 1:u=q;break;case 4:return m.label++,{value:q[1],done:!1};case 5:m.label++,l=q[1],q=[0];continue;case 7:q=m.ops.pop(),m.trys.pop();continue;default:if(u=m.trys,!((u=u.length>0&&u[u.length-1])||q[0]!==6&&q[0]!==2)){m=0;continue}if(q[0]===3&&(!u||q[1]>u[0]&&q[1]<u[3])){m.label=q[1];break}if(q[0]===6&&m.label<u[1]){m.label=u[1],u=q;break}if(u&&m.label<u[2]){m.label=u[2],m.ops.push(q);break}u[2]&&m.ops.pop(),m.trys.pop();continue}q=s.call(i,m)}catch(at){q=[6,at],l=0}finally{r=u=0}if(5&q[0])throw q[1];return{value:q[0]?q[1]:void 0,done:!0}}([B,G])}}},c=this&&this.__spreadArray||function(i,s,r){if(r||arguments.length===2)for(var l,u=0,I=s.length;u<I;u++)!l&&u in s||(l||(l=Array.prototype.slice.call(s,0,u)),l[u]=s[u]);return i.concat(l||Array.prototype.slice.call(s))},a=this&&this.__importDefault||function(i){return i&&i.__esModule?i:{default:i}};Object.defineProperty(b,"__esModule",{value:!0});var o=y(969),t=a(y(737)),e=y(190),n=function(i){function s(r,l,u){var I,m,A,B,G,q,at,xt,mt,it,lt,ct,vt,$t,wt,ht,St,jt,Dt,Gt,Ht,qt,Zt,It,Pt,J=i.call(this,r,l,u)||this,Tt=r.getAttribute("data-hs-combo-box"),Qt=Tt?JSON.parse(Tt):{},tt=v(v({},Qt),l);return J.gap=5,J.viewport=(I=typeof(tt==null?void 0:tt.viewport)=="string"?document.querySelector(tt==null?void 0:tt.viewport):tt==null?void 0:tt.viewport)!==null&&I!==void 0?I:null,J.preventVisibility=(m=tt==null?void 0:tt.preventVisibility)!==null&&m!==void 0&&m,J.apiUrl=(A=tt==null?void 0:tt.apiUrl)!==null&&A!==void 0?A:null,J.apiDataPart=(B=tt==null?void 0:tt.apiDataPart)!==null&&B!==void 0?B:null,J.apiQuery=(G=tt==null?void 0:tt.apiQuery)!==null&&G!==void 0?G:null,J.apiSearchQuery=(q=tt==null?void 0:tt.apiSearchQuery)!==null&&q!==void 0?q:null,J.apiHeaders=(at=tt==null?void 0:tt.apiHeaders)!==null&&at!==void 0?at:{},J.apiGroupField=(xt=tt==null?void 0:tt.apiGroupField)!==null&&xt!==void 0?xt:null,J.outputItemTemplate=(mt=tt==null?void 0:tt.outputItemTemplate)!==null&&mt!==void 0?mt:`<div class="cursor-pointer py-2 px-4 w-full text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800" data-hs-combo-box-output-item>
...
>
`,Cn=`<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
...
`,Bn=`<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto pt-20">\r
  <div class="mx-auto my-10 md:my-16">\r
    <div class="flex md:flex-row flex-col-reverse justify-center lg:gap-x-48 items-center px-8">\r
      <div>\r
        <h1 class="lg:text-6xl text-4xl font-semibold">Get Started Now!</h1>\r
        <p class="md:text-2xl text-xl my-5">Download our app to begin.</p>\r
        <div class="flex justify-start items-center gap-x-10">\r
          <a\r
          href="https://play.google.com/store/apps/details?id=com.sudoyantra.admin&hl=en"\r
            class="bg-secondary p-2 rounded-lg text-sm lg:text-xl font-semibold cursor-pointer"\r
          >\r
            Download App\r
        </a>\r
          <a href="https://play.google.com/store/apps/details?id=com.sudoyantra.admin&hl=en" class="cursor-pointer">\r
            <img class="md:h-10 h-8" src="google-play.webp" alt="" />\r
          </a>\r
        </div>\r
      </div>\r
     <div class="relative">\r
        <img class="md:h-[70vh]" src="phonewithapp.png" alt="" />\r
     </div>\r
    </div>\r
    <div class="flex md:flex-row flex-col gap-x-5 justify-center px-8 items-center">\r
        <img class="md:h-96 my-10 md:my-0 border-2 border-black p-2 rounded-lg" src="app-4.jpeg" alt="">\r
        <a href="https://kc.sudoyantra.com/realms/Sudoyantra/protocol/openid-connect/auth?client_id=AMNS&redirect_uri=https%3A%2F%2Fapp.sudoyantra.com%2F&state=175901e3-d0f2-45d9-9a6e-08106959c9f9&response_mode=fragment&response_type=code&scope=openid&nonce=ca056c7b-096a-4a88-83ce-803a5737f263" class="bg-secondary p-2 rounded-lg text-sm lg:text-xl font-semibold cursor-pointer">Go to dashboard</a>\r
    </div>\r
  </div>\r
</div>\r
`,$e={"/":un,"/#home":un,"/#about":Ln,"/#product":Cn,"/#product-details":_n,"/#work":En,"/#team":Sn,"/#blog":In,"/#contact":Tn,"/#solution":jn,"/#data":pn,"/#demo":An,"/#faq":On,"/#robot":Bn,"/#404":pn,"/#delete":Pn},on=document.getElementById("app");on.innerHTML=$e[window.location.pathname.split("?")[0]];const sn=nt=>{window.scrollTo(0,0),window.history.pushState({},nt,window.location.origin+nt);try{const st=document.querySelector(nt.split("?")[0].replace("/","")),Lt=document.querySelector("#home");Lt&&(Lt.className="!text-white !font-semibold font-medium  py-3 md:py-6 !text-blue-600 !font-semibold"),st&&(console.log(nt,"path"),nt&&Object.keys($e).forEach(gt=>{try{const W=document.querySelector(gt.split("?")[0].replace("/","")??"home");W&&(W.className="!text-gray-600 hover:!text-gray-800 font-medium  py-3 md:py-6 !font-semibold")}catch{}}),st.className=" font-medium  py-3 md:py-6 !text-blue-600 !font-semibold")}catch{if(nt.split("?")[0].replace("/","")==="home"||nt){Object.keys($e).forEach(gt=>{try{const W=document.querySelector(gt.split("?")[0].replace("/","")??"home");W&&(W.className="font-medium !text-gray-800 hover:text-gray-600 py-3 md:py-6 dark:text-gray-200 dark:hover:text-gray-500")}catch{}});const Lt=document.querySelector("#home");Lt&&(Lt.className="font-medium  py-3 md:py-6 !text-blue-600 !font-semibold")}}on.innerHTML=$e[nt.split("?")[0]]||`<section class="bg-white dark:bg-gray-900 ">
...
</section>`};window.onpopstate=()=>{on.innerHTML=$e[window.location.pathname]};document.addEventListener("DOMContentLoaded",()=>{console.log(window.location.href),console.log(window.location.hash),sn("/"+window.location.hash)});window.addEventListener("hashchange",()=>(console.log(window.location.hash),sn("/"+window.location.hash),!1));window.onNavigate=sn;const nn=document.getElementById("hero-input"),Je=document.getElementById("subscribe-button"),Mn=async()=>{const nt=nn==null?void 0:nn.value;Je.innerHTML=`
 ...
 Subscribed`}).catch(st=>{console.log(st),Je.innerHTML="Failed"})},Dn=async()=>{const nt=document.getElementById("contact-form"),st=document.getElementById("contact-button"),Lt=nt.first_name,gt=nt.last_name,W=nt.email,Y=nt.details,b=nt.phone;st.innerHTML=`
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="animate-spin h-5 w-5 mr-3">
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
</svg>

  Sending`,await fetch("https://api.emailjs.com/api/v1.0/email/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({service_id:"service_7xa5tqi",template_id:"template_t7jwhdf",user_id:"7Fopngk117L_VVFZz",template_params:{first_name:Lt.value,last_name:gt.value,email:W.value,details:Y.value,phone:b.value}})}).then(y=>{console.log(y),st.style.backgroundColor="#10b981",st.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
</svg>
 Subscribed`}).catch(y=>{console.log(y),st.innerHTML="Failed"})},qn=async()=>{const nt=document.getElementById("delete-form"),st=document.getElementById("delete-button"),Lt=nt.first_name,gt=nt.phone;st.innerHTML=`
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="animate-spin h-5 w-5 mr-3">
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
</svg>

  Sending`,await fetch("https://api.emailjs.com/api/v1.0/email/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({service_id:"service_7xa5tqi",template_id:"template_t7jwhdf",user_id:"7Fopngk117L_VVFZz",template_params:{first_name:Lt.value,phone:gt.value}})}).then(W=>{console.log(W),st.style.backgroundColor="#10b981",st.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
</svg>
 Delete request send`}).catch(W=>{console.log(W),st.innerHTML="Failed"})};window.submitDeleteLetter=qn;window.submitNewsLetter=Mn;window.submitContactLetter=Dn;window.addEventListener("scroll",()=>{const nt=document.getElementById("first-nav"),st=document.getElementById("second-nav");window.scrollY>10?(nt.classList.add("hidden"),st.classList.add("visible")):(nt.classList.remove("hidden"),st.classList.remove("visible"))});const Hn=new URLSearchParams(window.location.search);Hn.has("id")&&(window.location.href="https://www.sudoyantra.com/#robot");
